...
#######################################################################################
# Lectura de datos
inmuebles <- read_excel("data_orden/BaseDatosInmueblesPortada02-09-2022.xls")
...
localizaciones <- unique(read.csv("data/localizaciones_1.csv",sep=",",header=T))
...
write.csv2(x = inmuebles, file = "data_orden/inmuebles_2.csv", row.names = F,
           fileEncoding = "UTF-8")
