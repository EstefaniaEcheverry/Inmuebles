...
#######################################################################################
# Lectura de datos
inmuebles <- read_excel("data_orden/BaseDatosInmueblesPortada14-09-2022.xls")
...
datos <- read.csv2("data_orden/inmuebles_13.csv", header= TRUE,
                   fileEncoding = "UTF-8")
...
write.csv2(x = inmuebles, file = "data_orden/inmuebles_14.csv", row.names = F,
           fileEncoding = "UTF-8")
