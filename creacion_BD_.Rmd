...
Para esta primera parte usaremos la data de la carpeta data_orden del archivo inmuebles_21.csv.
...
datos_completos$Direcciones_c<-str_trim(Direcciones_c)
...
```{r Lectura de datos}
#######################################################################################
file_actual<-"data_orden/BaseDatosInmueblesPortada21-09-2022.xls"
# Lectura de datos
...
inmuebles$Direcciones_c <- str_trim(Direcciones_c)
...
address_nuevas<-paste(inmuebles$Direcciones_c, inmuebles$Ciudad,'Colombia',sep=', ' ) 
address_actuales<-paste(localizaciones$Direcciones_c,localizaciones$Ciudad,'Colombia',sep = ', ' )
...
localizaciones<-read.csv2("BD/localizacion_inmuebles.csv",header=T)
localizaciones_corr$addres_temp<-paste(strtrim(localizaciones_corr$address),
                                    toupper(localizaciones_corr$Ciudad),sep=' ')
