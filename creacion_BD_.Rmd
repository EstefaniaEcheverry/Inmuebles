...
palabras_eliminar <-c("AP", "INT","BL","CASA", "CS","IN", "APT", "OF", "TO","CA","PH",
                       "VISIT", "ETAPA", "APTOS","BRR","PISO","LO", "P.H", "CONS","CONJUN" ,"PRIMER","PI","CUAR","P 1")
```
...
```{r Lectura de datos}
#######################################################################################
file_actual<-"data_orden/BaseDatosInmueblesPortada30-09-2022.xls"
# Lectura de datos
...
```{r}
localizaciones<-read.csv2("BD/localizacion_inmuebles.csv",header=T)
filtro_prueba<- localizaciones$localizaciones.lat==6.34034 & localizaciones$localizaciones.long==-75.55916
