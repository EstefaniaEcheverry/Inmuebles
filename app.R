                ...
                tabBox(id="t1",width= 12,
                       ...
                       tabPanel(title="Información",icon = icon("address-card"),fluidRow(
                         ...
                         column(width = 4, tags$br() ,
                                tags$p(" Son 5982 inmuebles controlados por los diferentes Centros de costos , 
                                     según los datos 17 de estos inmuebles están bloqueados o desactivados,
                                     es decir, existen 5927 inmuebles activos distribuidos por los centros 
                                     de costos; Los Colores maneja 1105 de estos inmuebles y Laureles 898 inmuebles. ")
                         )
                       )
...
server <- function(input, output, session) {
  ...
  area_metropolitana <- read_sf("mapa/geoBoundaries-COL-ADM2.shp")%>%
  ...
  area_metropolitana$shapeName<-c("MEDELLIN",# no son de antioquia
                              "BELLO",
                              "CALDAS",
                              "COPACABANA",
                              "ENVIGADO",
  ...
  area_metropolitana <- area_metropolitana[!(area_metropolitana$shapeName == "No_Caldas" & 
                                               area_metropolitana$shapeName == "No_Rionegro"),]
                ...
                tabBox(id="t1",width= 12,
                       ...
                       tabPanel(title="Información",icon = icon("address-card"),fluidRow(
                         column(width = 8, tags$img(src="image.png", width =400 , height = 200,alt ="Something went wrong",deleteFile=FALSE),
                                align = "center"),
                         column(width = 4, tags$br() ,
                                tags$p(" Son 5961 inmuebles controlados por los diferentes Centros de costos , 
                                     según los datos 34 de estos inmuebles están bloqueados o desactivados,
                                     es decir, existen 5927 inmuebles activos distribuidos por los centros 
                                     de costos; Los Colores maneja 1098 de estos inmuebles y Laureles 897 inmuebles. ")
                         )
                       )
