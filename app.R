                ...
                tabBox(id="t1",width= 12,
                       ...
                       tabPanel(title="Información",icon = icon("address-card"),fluidRow(
                         ...
                         column(width = 4, tags$br() ,
                                tags$p(" Son 6005 inmuebles controlados por los diferentes Centros de costos , 
                                     según los datos 118 de estos inmuebles están bloqueados o desactivados,
                                     es decir, existen 5887 inmuebles activos distribuidos por los centros 
                                     de costos; Los Colores maneja 1088 de estos inmuebles y Laureles 889 inmuebles. ")
                         )
                       )
